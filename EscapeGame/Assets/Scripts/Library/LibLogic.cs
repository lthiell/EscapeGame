...
/*
 * Zentrale Logik für das Level Bibliothek.
 */
public class LibLogic : MonoBehaviour
{
    ...
    private void SetComputerBackgroundDefaultMaterial()
    {
    ...
    public void HandleWrongComputerPassword()
    {
        ...
        Invoke("SetComputerBackgroundDefaultMaterial", 2.0f);
